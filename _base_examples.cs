...
public static class DiagramExamples
{
	...
	[
		...
		new("mindmap-learning", "Learning Path", DiagramCategory.Mindmap,
			"mindmap\n  ((Web Development))\n    (Frontend)\n      HTML\n      CSS\n      JavaScript\n    (Backend)\n      .NET\n      Node.js\n    ))Cloud((\n      AWS\n      Azure"),
		// ΓöÇΓöÇ Real World (RFC diagrams) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
		...
		new("rfc-loading-flow", "Loading Flow", DiagramCategory.RealWorld, """
			flowchart TD
			    ...
			    hasV2 -->|Yes| loadV2["Load toc-v2.yml\n(required ΓÇö no fallback to toc.yml)"]
