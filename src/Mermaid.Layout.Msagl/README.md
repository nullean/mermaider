# Mermaid.Layout.Msagl

Optional [Microsoft MSAGL](https://github.com/microsoft/automatic-graph-layout) layout provider for
[Mermaid.NET](https://github.com/nullean/mermaid-dotnet).

Mermaid.NET ships with a fast, zero-dependency Sugiyama layout engine by default. This package provides
...
- You're migrating from an earlier version of Mermaid.NET that used MSAGL and want identical output
