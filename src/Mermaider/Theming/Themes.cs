...
public static class Themes
{
	...
	public static FrozenDictionary<string, DiagramColors> BuiltIn { get; } =
		new Dictionary<string, DiagramColors>
		{
			...
			{
				Bg = "#1a1b26", Fg = "#a9b1d6",
				Line = "#3d59a1", Accent = "#7aa2f7", Muted = "#7982aa",
				DataPalette = DarkDataPalette
			},
			...
			{
				Bg = "#1e1e2e", Fg = "#cdd6f4",
				Line = "#585b70", Accent = "#cba6f7", Muted = "#9399b2",
				DataPalette = DarkDataPalette
			},
			...
			{
				Bg = "#2e3440", Fg = "#d8dee9",
				Line = "#4c566a", Accent = "#88c0d0", Muted = "#8896af",
				DataPalette = DarkDataPalette
			},
			["nord-light"] = new()
			{
			...
			{
				Bg = "#282a36", Fg = "#f8f8f2",
				Line = "#6272a4", Accent = "#bd93f9", Muted = "#8899c7",
				DataPalette = DarkDataPalette
			},
			["github-light"] = new()
			{
			...
			{
				Bg = "#002b36", Fg = "#839496",
				Line = "#586e75", Accent = "#268bd2", Muted = "#839496",
				DataPalette = DarkDataPalette
			},
			["one-dark"] = new()
			{
				Bg = "#282c34", Fg = "#abb2bf",
				Line = "#4b5263", Accent = "#c678dd", Muted = "#828997",
				DataPalette = DarkDataPalette
			},
		}.ToFrozenDictionary();
}
